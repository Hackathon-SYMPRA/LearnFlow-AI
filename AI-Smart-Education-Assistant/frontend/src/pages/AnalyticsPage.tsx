          ...
          <CardContent>
            <div className="h-72 w-full">
              <ResponsiveContainer width="100%" height="100%">
                <AreaChart data={weeklyStudy} margin={{ top: 10, right: 10, left: -20, bottom: 0 }}>
                  <defs>
      ...
      <div className="grid grid-cols-1 gap-6 lg:grid-cols-3">
        <Card className="lg:col-span-2">
          ...
          <CardContent>
            <div className="h-72 w-full">
              <ResponsiveContainer width="100%" height="100%">
                <LineChart data={quizHistory} margin={{ top: 10, right: 10, left: -20, bottom: 0 }}>
                  <CartesianGrid strokeDasharray="3 3" className="stroke-slate-200 dark:stroke-slate-800" />
                  <XAxis dataKey="week" className="text-xs fill-slate-500 dark:fill-slate-400" tickLine={false} axisLine={false} />
                  <YAxis domain={[50, 100]} className="text-xs fill-slate-500 dark:fill-slate-400" tickLine={false} axisLine={false} />
                  <Tooltip
                    contentStyle={{
                      backgroundColor: 'rgb(15 23 42)',
                      border: '1px solid rgb(30 41 59)',
        ...
        <Card>
          ...
          <CardContent>
            <ul className="space-y-4">
              {[...subjectScores].sort((a, b) => b.score - a.score).slice(0, 6).map((s) => (
                <li key={s.subject}>
                  <div className="flex items-center justify-between mb-1.5">
                    <div className="flex items-center gap-2">
                      ...
                      <span className="text-sm font-medium text-slate-900 dark:text-slate-100">{s.subject}</span>
                    </div>
                    <span className="text-sm font-bold text-slate-900 dark:text-slate-100">{s.score}%</span>
                  </div>
      ...
      <div className="grid grid-cols-1 gap-6 lg:grid-cols-2">
        <Card>
          <CardHeader>
            ...
            <CardDescription>Average quiz scores across subjects</CardDescription>
          </CardHeader>
          <CardContent>
            <div className="h-72 w-full">
              <ResponsiveContainer width="100%" height="100%">
                <BarChart data={subjectScores} margin={{ top: 10, right: 10, left: -20, bottom: 0 }}>
                  ...
                  <YAxis domain={[0, 100]} className="text-xs fill-slate-500 dark:fill-slate-400" tickLine={false} axisLine={false} />
                  <Tooltip
                    contentStyle={{
                      backgroundColor: 'rgb(15 23 42)',
                      border: '1px solid rgb(30 41 59)',
            ...
            <ul className="space-y-5">
              <li className="flex items-center justify-between">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <p className="text-sm font-medium text-slate-900 dark:text-slate-100">AI Questions Asked</p>
                    <p className="text-xs text-slate-500 dark:text-slate-400">Total conversations with tutor</p>
                  </div>
                </div>
                <span className="text-lg font-bold text-slate-900 dark:text-slate-100">147</span>
              </li>
              <li className="flex items-center justify-between">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <p className="text-sm font-medium text-slate-900 dark:text-slate-100">Flashcards Reviewed</p>
                    <p className="text-xs text-slate-500 dark:text-slate-400">Spaced repetition practice</p>
                  </div>
                </div>
                <span className="text-lg font-bold text-slate-900 dark:text-slate-100">180</span>
              </li>
              <li className="flex items-center justify-between">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <p className="text-sm font-medium text-slate-900 dark:text-slate-100">Questions Correct</p>
                    <p className="text-xs text-slate-500 dark:text-slate-400">Cumulative quiz performance</p>
                  </div>
                </div>
                <span className="text-lg font-bold text-slate-900 dark:text-slate-100">402 / 480</span>
              </li>
              <li className="flex items-center justify-between">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <p className="text-sm font-medium text-slate-900 dark:text-slate-100">Avg. Session Duration</p>
                    <p className="text-xs text-slate-500 dark:text-slate-400">Per active learning session</p>
                  </div>
                </div>
                <span className="text-lg font-bold text-slate-900 dark:text-slate-100">52 min</span>
              </li>
            </ul>
          </CardContent>
        </Card>
