...
export const VoiceRecorder = ({ isOpen, onClose, onTranscript }) => {
  const [state, setState] = useState("idle");
  const [elapsed, setElapsed] = useState(0);
  const [transcript, setTranscript] = useState("");
  const [interim, setInterim] = useState("");
  const [bars, setBars] = useState(() => Array.from({ length: 32 }, () => 0.2));
  ...
  const startBars = useCallback(() => {
    barsRef.current = setInterval(() => {
      setBars(Array.from({ length: 32 }, () => 0.3 + Math.random() * 0.7));
    }, 90);
  }, []);
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-amber-700 dark:text-amber-400 mt-1">
                      Your browser does not support speech recognition. Try
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-rose-700 dark:text-rose-400 mt-1">
                      Grant microphone permission in your browser settings, then
                      retry.
                    </p>
                  </div>
                </div>
              ...
              >
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-amber-700 dark:text-amber-400 mt-1">
                      We couldn&apos;t capture any words. Record at least a
                      second of speech.
                    </p>
                  </div>
                </div>
