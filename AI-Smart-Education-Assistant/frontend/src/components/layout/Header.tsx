...
export const Header: React.FC<HeaderProps> = ({ onToggleSidebar }) => {
  ...
  const { internetStatus, aiStatus, currentSubject, setCurrentSubject, openGlobalSearch } = useApp();
    ...
    >
      <div className="flex h-full items-center gap-4 px-4 sm:px-6">
        ...
        <div className="flex items-center gap-2 lg:hidden">
          ...
          <span className="font-bold text-slate-900 dark:text-slate-100">EduMind</span>
        </div>
        ...
        >
          ...
          <span className="flex-1 truncate">Search documents, chats, notes...</span>
        ...
        <div className="hidden lg:flex items-center" ref={subjectRef}>
          ...
          >
            ...
            <ChevronDown className={cn('h-4 w-4 transition-transform', subjectOpen && 'rotate-180')} />
          </button>
          <AnimatePresence>
            {subjectOpen && (
              <motion.div
        ...
        <div className="ml-auto flex items-center gap-1 sm:gap-2">
          <div className="flex items-center gap-1">
            ...
            >
              ...
              <span className="hidden xl:inline">{internetStatus.isOnline ? 'Online' : 'Offline'}</span>
            </span>
          ...
          <div className="relative" ref={profileRef}>
            ...
            >
              ...
              <ChevronDown
                className={cn('hidden sm:block h-4 w-4 text-slate-500 transition-transform', profileOpen && 'rotate-180')}
                aria-hidden="true"
              />
            </button>
            <AnimatePresence>
