...
const SubjectModal = ({ open, onClose, onSubmit, editing, mode }) => {
  const {
    register,
    handleSubmit,
    setValue,
          ...
          <div className="flex items-start justify-between mb-5">
            <div>
              ...
              >
                ...
                {mode === "color" &&
                  `Set Color for ${editing?.name ?? "Subject"}`}
                {mode === "icon" &&
                  `Set Icon for ${editing?.name ?? "Subject"}`}
              </h2>
              <p className="mt-1 text-sm text-slate-500 dark:text-slate-400">
                {mode === "create" &&
                  "Organize your study materials with subject categories"}
                {mode === "rename" && "Update the display name of this subject"}
                {mode === "color" &&
                  "Choose a color to visually identify this subject"}
                  ...
                  {SUBJECT_COLORS.map((color) => (
                    <button
                      ...
                      className={cn(
                        ...
                        selectedColor === color
                          ? "ring-2 ring-slate-900 dark:ring-slate-100 scale-105"
                          : "hover:scale-105",
                      )}
...
const DeleteDialog = ({ open, subject, onConfirm, onCancel }) => {
          ...
          <div className="flex items-start gap-4">
            ...
            <div className="flex-1 min-w-0">
              ...
              <p className="mt-2 text-sm text-slate-500 dark:text-slate-400">
                This will remove the subject category. Documents are not deleted
...
export const SubjectsPage = () => {
  ...
  const carouselVisible = recentSubjects.slice(
    carouselStart,
    carouselStart + 4,
  );
            ...
            <div className="px-6 py-4 border-b border-slate-200 dark:border-slate-800 flex items-center justify-between">
              <div>
                ...
                <p className="mt-0.5 text-sm text-slate-500 dark:text-slate-400">
                  Subjects you recently worked with
                </p>
              </div>
              <div className="flex items-center gap-1">
                ...
                <button
                  ...
                  onClick={() =>
                    setCarouselStart((s) =>
                      Math.min(Math.max(0, recentSubjects.length - 4), s + 1),
                    )
                  }
      ...
      <motion.div variants={item}>
        ...
        {filteredSubjects.length === 0 ? (
          <EmptyState
            ...
            description={
              search
                ? "Try a different search term or create a new subject."
                : "Create subjects to organize your study materials into categories."
            }
            action={
              search
                ? undefined
