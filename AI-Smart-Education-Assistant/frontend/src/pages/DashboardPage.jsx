...
const recentDocuments = [
  ...
  },
  {
    ...
    subject: "Chemistry",
    status: "ready",
    uploadedAt: new Date(Date.now() - 7200000 * 2).toISOString(),
  },
  {
    id: "3",
...
const recentActivity = [
  ...
  },
  {
    ...
    time: new Date(Date.now() - 7200000 * 2).toISOString(),
  },
  {
    id: "3",
    type: "flashcard",
  ...
  },
  {
    id: "4",
    type: "chat",
    title: "Chatted about Trigonometry",
    time: new Date(Date.now() - 86400000).toISOString(),
  },
];
...
const upcomingSchedule = [
  ...
  {
    id: "2",
    title: "Practice Quiz - Organic Chem",
    subject: "Chemistry",
  ...
  {
    id: "3",
    title: "Read Physics Waves Notes",
    subject: "Physics",
...
const recommendations = [
  {
    ...
    reason: "You scored 70% on this topic",
    action: "Review",
  ...
  {
    id: "2",
    title: "Generate Quiz on Chemical Bonds",
    reason: "Based on your recent uploads",
    action: "Generate",
    route: ROUTES.quiz,
    icon: BrainCircuit,
  },
  {
    id: "3",
    title: "Study Plan: Week 8",
    reason: "Recommended 3 sessions this week",
    action: "View Plan",
...
export const DashboardPage = () => {
  ...
  return (
    ...
    >
      <motion.div
        variants={item}
        className="card overflow-hidden bg-gradient-to-br from-primary-600 via-primary-500 to-secondary-600 p-6 sm:p-8 text-white"
      >
        <div className="flex flex-col gap-6 lg:flex-row lg:items-center lg:justify-between">
          <div className="min-w-0">
            ...
            <p className="mt-3 max-w-xl text-sm text-primary-100">
              You have studied{" "}
              <span className="font-semibold text-white">18.3 hours</span> this
              week. Keep up the streak and complete today's study goal!
            </p>
            ...
            <CardHeader>
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <CardDescription>
                    Areas of excellence and areas to improve
                  </CardDescription>
                </div>
              </div>
            </CardHeader>
            ...
            <CardHeader>
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <CardDescription>
                    Past conversations with AI tutor
                  </CardDescription>
                </div>
                <Button
                  variant="ghost"
            ...
            <CardHeader>
              <div className="flex items-center justify-between">
                ...
                <Button
                  ...
                  rightIcon={<CalendarCheck className="h-4 w-4" />}
                >
                  Planner
                </Button>
              </div>
      ...
      <motion.div variants={item}>
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Your latest actions and accomplishments
            </CardDescription>
          </CardHeader>
          <CardContent>
            <ul className="space-y-2">
              {recentActivity.map((activity) => (
                <li
                  key={activity.id}
                  className="flex items-center gap-3 rounded-xl p-3 hover:bg-slate-50 dark:hover:bg-slate-800/50 transition-colors"
                >
                  <div
                    className={cn(
                      ...
                      activity.type === "flashcard" &&
                        "bg-secondary-50 text-secondary-600 dark:bg-secondary-950/40 dark:text-secondary-400",
                      activity.type === "chat" &&
