...
const categorizeFile = (file: File): 'image' | 'doc' | 'other' => {
    ...
    (fileList: FileList | null) => {
      ...
      files.forEach((f) => {
        ...
        accepted.push({
          ...
          type: cat,
          previewUrl:
            cat === 'image' ? URL.createObjectURL(f) : undefined,
        });
      });
    ...
    <div className="relative w-full">
      ...
      {isOverLimit && (
        ...
        >
          ...
          Message exceeds maximum of {MAX_MESSAGE_LENGTH} characters ({charCount})
        </motion.div>
      )}
