...
export const DEFAULT_THEME = (import.meta.env.VITE_DEFAULT_THEME || 'light') as 'light' | 'dark';

export const ROUTES: Record<PageRoute, string> = {
  dashboard: '/dashboard',
  upload: '/upload',
  chat: '/chat',
  quiz: '/quiz',
...
export const NOTIFICATION_SUBTYPES: Record<string, string> = {
...
export const NAVIGATION_ITEMS: {
  ...
  { route: 'dashboard', label: 'Dashboard', description: 'Overview of your learning' },
  { route: 'upload', label: 'Upload Center', description: 'Upload study materials' },
  { route: 'chat', label: 'AI Chat', description: 'Ask AI about your documents' },
  { route: 'quiz', label: 'Quiz Generator', description: 'Test your knowledge' },
  { route: 'flashcards', label: 'Flashcards', description: 'Spaced repetition learning' },
  { route: 'planner', label: 'Study Planner', description: 'Organize your study schedule' },
  { route: 'history', label: 'Chat History', description: 'Review past conversations' },
  { route: 'analytics', label: 'Analytics', description: 'Track your progress' },
