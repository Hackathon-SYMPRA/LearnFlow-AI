...
const DEFAULT_RELATED = [
  {
    id: "r1",
    name: "Calculus_Chapter3_Limits.pdf",
    pages: 42,
    subject: "Mathematics",
  },
  {
    id: "r2",
    name: "LinearAlgebra_Vectors_Notes.docx",
    pages: 18,
    subject: "Mathematics",
  },
  {
    id: "r3",
    name: "Physics_Mechanics_StudyGuide.pdf",
    pages: 67,
    subject: "Physics",
  },
  {
    id: "r4",
    name: "Chemistry_Bonding_Summary.pdf",
    pages: 24,
    subject: "Chemistry",
  },
];
              ...
              {citations.length === 0 ? (
                <div className="rounded-xl border border-dashed border-slate-300 dark:border-slate-700 p-4 text-center">
                  ...
                  <p className="mt-2 text-xs text-slate-500 dark:text-slate-400">
                    No sources cited yet. Ask a question about your documents to
                    see references.
                  </p>
                </div>
              ) : (
                    ...
                    <div className="mb-4">
                      ...
                      <div className="h-2 w-full rounded-full bg-slate-200 dark:bg-slate-800 overflow-hidden">
                        <div
                          className={cn(
                            "h-full rounded-full",
                            getConfidenceTone(citations[snippetOpen].confidence)
                              .bar,
                          )}
                          style={{
                            width: `${
