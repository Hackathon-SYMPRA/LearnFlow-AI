...
import { ROUTES, SUBJECT_COLORS, STORAGE_KEYS } from "@/constants";
...
const getDemoDocuments = () => [
  ...
  {
    id: generateId(),
    name: "Organic_Chemistry_Notes_Reactions.pdf",
    type: "pdf",
    size: 5400000,
    status: "ready",
  ...
  {
    id: generateId(),
    name: "Physics_Waves_and_Optics.docx",
    type: "doc",
    size: 890000,
    status: "processing",
    uploadDate: new Date(Date.now() - 3600000 * 1).toISOString(),
    subject: "Physics",
    pages: 18,
    progress: 65,
    favorite: false,
  ...
  {
    id: generateId(),
    name: "Diagram_Mitochondria_Structure.png",
    type: "image",
    size: 2100000,
    status: "ready",
  ...
  {
    id: generateId(),
    name: "Macroeconomics_Study_Guide.pdf",
    type: "pdf",
    size: 4100000,
    status: "ready",
    ...
    pages: 58,
    favorite: true,
    lastOpened: new Date(Date.now() - 3600000 * 10).toISOString(),
  },
  {
    id: generateId(),
    name: "Hamlet_Act_by_Act_Analysis.docx",
    type: "doc",
    size: 520000,
    status: "ready",
  ...
  {
    id: generateId(),
    name: "Quantum_Mechanics_Lecture.jpg",
    type: "image",
    size: 3500000,
    status: "ready",
  ...
  {
    id: generateId(),
    name: "Neural_Networks_Overview.pdf",
    type: "pdf",
    size: 6200000,
    status: "failed",
    uploadDate: new Date(Date.now() - 3600000 * 30).toISOString(),
    subject: "Computer Science",
    pages: 88,
    favorite: false,
    processingError: "File corrupted during upload",
  },
];
...
const PreviewModal = ({ open, doc, onClose, onDownload }) => {
            ...
            <div className="flex-1 overflow-auto p-6 bg-slate-50 dark:bg-slate-950/50">
              <div className="mx-auto max-w-2xl rounded-xl border border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-900 shadow-sm p-8 min-h-[500px]">
                ...
                <div className="space-y-4 text-slate-700 dark:text-slate-300 leading-relaxed">
                  ...
                  <p>
                    This is a preview representation of your study document. In
                    production, this would render the actual PDF pages, document
                    text, or image content. The preview allows you to quickly
                    verify the document content before asking questions or
                    generating quizzes.
                  </p>
                  <p className="font-medium text-lg text-slate-900 dark:text-slate-100 mt-6">
                    Key Topics
                  </p>
                  <ul className="list-disc pl-5 space-y-1.5">
                    <li>
                      Introduction to core concepts and foundational material
                    </li>
                    <li>Detailed analysis with examples and diagrams</li>
                    <li>Practical applications and real-world scenarios</li>
                    <li>
                      Summary and review questions at the end of each section
                    </li>
            ...
            <aside className="hidden lg:block w-72 shrink-0 border-l border-slate-200 dark:border-slate-800 p-5 overflow-auto bg-white dark:bg-slate-900">
              ...
              <dl className="space-y-4 text-sm">
                <div>
                  ...
                  <dd className="font-medium text-slate-900 dark:text-slate-100 mt-0.5 uppercase">
                    {doc.type}
                  </dd>
                </div>
                <div>
...
export const LibraryPage = () => {
  ...
  const filtered = useMemo(() => {
    ...
    if (selectedSubjects.length > 0) {
      list = list.filter(
        (d) => d.subject && selectedSubjects.includes(d.subject),
      );
    }
    if (favoritesOnly) {
  ...
  const handleToggleFavorite = (doc) => {
    ...
    toast.success(
      doc.favorite ? "Removed from favorites" : "Added to favorites",
    );
  };
            ...
            <div className="flex flex-col gap-3 lg:flex-row lg:items-center">
              ...
              <div className="flex items-center gap-2">
                ...
                <button
                  ...
                  aria-label={
                    favoritesOnly ? "Show all documents" : "Show favorites only"
                  }
                >
                  <Star
                    className={cn(
                      "h-4 w-4",
                      favoritesOnly ? "fill-warning-500 text-warning-500" : "",
                    )}
                  />
...
const SelectDocSort = ({ value, onChange }) => {
  return (
