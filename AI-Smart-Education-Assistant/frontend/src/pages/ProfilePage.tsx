...
import { UserCircle, Mail, Save, Camera, BookOpen, Clock, Trophy } from 'lucide-react';
        ...
        <div className="p-6 sm:p-8">
          <div className="flex flex-col gap-6 sm:flex-row sm:items-center">
            ...
            <div className="min-w-0 flex-1">
              ...
              <p className="mt-1 text-sm text-white/80">{user?.email ?? 'user@example.com'}</p>
          ...
          <CardContent>
            <ul className="space-y-4">
              <li className="flex items-center justify-between rounded-xl border border-slate-200 dark:border-slate-800 p-4 hover:bg-slate-50 dark:hover:bg-slate-800/50 transition-colors">
                <div>
                  <p className="text-sm font-medium text-slate-900 dark:text-slate-100">Default Subject</p>
                  <p className="mt-0.5 text-xs text-slate-500 dark:text-slate-400">New documents will be tagged with this</p>
                </div>
              ...
              <li className="flex items-center justify-between rounded-xl border border-slate-200 dark:border-slate-800 p-4 hover:bg-slate-50 dark:hover:bg-slate-800/50 transition-colors">
                <div>
                  <p className="text-sm font-medium text-slate-900 dark:text-slate-100">Daily Study Goal</p>
                  <p className="mt-0.5 text-xs text-slate-500 dark:text-slate-400">Target hours of study per day</p>
                </div>
              ...
              <li className="flex items-center justify-between rounded-xl border border-slate-200 dark:border-slate-800 p-4 hover:bg-slate-50 dark:hover:bg-slate-800/50 transition-colors">
                <div>
                  ...
                  <p className="mt-0.5 text-xs text-slate-500 dark:text-slate-400">Email and app notifications</p>
                </div>
